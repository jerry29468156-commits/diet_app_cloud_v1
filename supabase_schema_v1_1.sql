...
-- 飲食紀錄 App 正式雲端版 v1.1
-- 功能：多使用者、RLS、Realtime、完整 v7.3 UI 需要的資料表
...
-- Realtime：如果重複 add table 出現 already member 訊息，可忽略。
alter publication supabase_realtime add table public.user_settings;
alter publication supabase_realtime add table public.diet_targets;
...
alter publication supabase_realtime add table public.food_tags;
...
alter publication supabase_realtime add table public.meal_template_items;
