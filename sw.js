const CACHE_NAME='diet-app-v2-2-1-cache';
const ASSETS=['./','./index.html','./app_config.js','./manifest.webmanifest','./favicon.svg','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
